    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="lixiangxiangmuId" name="lixiangxiangmuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="进度标题" prop="zhuangxiujinduName">
                       <el-input v-model="ruleForm.zhuangxiujinduName"
                                 placeholder="进度标题" clearable  :readonly="ro.zhuangxiujinduName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="进度标题" prop="zhuangxiujinduName">
                           <el-input v-model="ruleForm.zhuangxiujinduName"
                                     placeholder="进度标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhuangxiujinduPhoto" label="进度图片" prop="zhuangxiujinduPhoto">
                        <file-upload
                            tip="点击上传进度图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.zhuangxiujinduPhoto?ruleForm.zhuangxiujinduPhoto:''"
                            @change="zhuangxiujinduPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhuangxiujinduPhoto" label="进度图片" prop="zhuangxiujinduPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.zhuangxiujinduPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="进度详情" prop="zhuangxiujinduText">
                        <el-input type="textarea"  :readonly="ro.zhuangxiujinduText" v-model="ruleForm.zhuangxiujinduText" placeholder="进度详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhuangxiujinduText" label="进度详情" prop="zhuangxiujinduText">
                            <span v-html="ruleForm.zhuangxiujinduText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    zhuangxiujinduName: false,
                    zhuangxiujinduPhoto: false,
                    zhuangxiujinduText: false,
                    insertTime: false,
                },
                ruleForm: {
                    lixiangxiangmuId: '',
                ...
                rules: {
                   ...
                   zhuangxiujinduName: [
                              { required: true, message: '进度标题不能为空', trigger: 'blur' },
                          ],
                   zhuangxiujinduPhoto: [
                              { required: true, message: '进度图片不能为空', trigger: 'blur' },
                          ],
                   zhuangxiujinduText: [
                              { required: true, message: '进度详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhuangxiujindu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhuangxiujinduCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            zhuangxiujinduPhotoUploadChange(fileUrls){
                this.ruleForm.zhuangxiujinduPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
