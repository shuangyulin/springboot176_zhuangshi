<template>
    <div style="backgroundImage: url('/zhuangshigongchengguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">装饰工程管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="联系方式" class="input" v-if="tableName=='kehu'">
                            <el-input v-model="ruleForm.kehuPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='kehu'">
                            <el-input v-model="ruleForm.kehuEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
