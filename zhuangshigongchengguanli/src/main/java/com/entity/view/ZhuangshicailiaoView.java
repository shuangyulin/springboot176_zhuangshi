...
public class ZhuangshicailiaoView extends ZhuangshicailiaoEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 材料类型的值
		*/
		private String zhuangshicailiaoValue;
	...
	public ZhuangshicailiaoView() {

	}

	public ZhuangshicailiaoView(ZhuangshicailiaoEntity zhuangshicailiaoEntity) {
		try {
			BeanUtils.copyProperties(this, zhuangshicailiaoEntity);
			...
			* 获取： 材料类型的值
			*/
			public String getZhuangshicailiaoValue() {
				return zhuangshicailiaoValue;
			}
			/**
			* 设置： 材料类型的值
			*/
			public void setZhuangshicailiaoValue(String zhuangshicailiaoValue) {
				this.zhuangshicailiaoValue = zhuangshicailiaoValue;
			}
