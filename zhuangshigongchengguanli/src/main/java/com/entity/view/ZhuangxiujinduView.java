...
public class ZhuangxiujinduView extends ZhuangxiujinduEntity implements Serializable {
	...
	public ZhuangxiujinduView() {

	}

	public ZhuangxiujinduView(ZhuangxiujinduEntity zhuangxiujinduEntity) {
		try {
			BeanUtils.copyProperties(this, zhuangxiujinduEntity);
