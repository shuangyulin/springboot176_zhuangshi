...
public class YushuanbaojiaView extends YushuanbaojiaEntity implements Serializable {
	...
	public YushuanbaojiaView() {

	}

	public YushuanbaojiaView(YushuanbaojiaEntity yushuanbaojiaEntity) {
		try {
			BeanUtils.copyProperties(this, yushuanbaojiaEntity);
